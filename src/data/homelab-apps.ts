...
export const HOMELAB_APPS: HomelabApp[] = [
  ...
  { name: 'Flux CD', desc: 'GitOps deployment management', url: 'https://github.com/doemefu/homelab', status: 'unknown', cat: 'Infra', repo: 'https://github.com/doemefu/homelab', workload: { kind: 'deployment', namespace: 'flux-system', name: 'kustomize-controller' } },
