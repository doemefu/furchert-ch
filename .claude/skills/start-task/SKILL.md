...
1. Thoroughly read the recent worklogs (`.claude/worklogs/`), `.claude/memory/MEMORY.md`, the implementation history in `docs/INDEX.md`, and the relevant prototype source before starting anything. Check for an `in_progress` worklog and resume it if present.
